...
class GamePane extends JComponent implements ActionListener {
    ...
    Timer timer, timer1, timer2, anim_timer, timerRapido;	//different timers used for animation of puyos
    ...
    public GamePane(int l, int r, int c) {
        ...
        addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent e) {
                ...
                } else if (e.getKeyCode() == KeyEvent.VK_ESCAPE && started) {
                    clips[2].play();
                ...
                if (e.getKeyCode() == KeyEvent.VK_I && !gameOver && !paused) {
    ...
    public void init()//all variables declared above are initialized here
    {
        ...
        anim_timer.start();
        timerRapido = new Timer(800, this);
        //timerRapido.start();
//starting the timer
    }
    ...
    public void setDelays() {
        int delay = 0, delay1 = 0,aumento=0;
