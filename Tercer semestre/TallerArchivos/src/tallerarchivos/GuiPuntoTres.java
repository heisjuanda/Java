 ...
 * @author JuanDavid
 */
public class GuiPuntoTres extends javax.swing.JFrame {

    /**
     * Creates new form GuiPuntoTres
     */
    public GuiPuntoTres() {
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Ruta1, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(Separador1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(18, 18, 18)
                        .addComponent(Ruta2, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TallerArchivos t = new TallerArchivos();
        String rut1 = " ", rut2 = " ", sepa1 = " ", sepa2 = " ";
        rut1 = Ruta1.getText();
        rut2 = Ruta2.getText();
        System.out.println(Ruta1.getText());
        System.out.println(Ruta2.getText());
        sepa1 = Separador1.getText();
        sepa2 = Separador2.getText();

        jTextArea1.setText(t.puntoTres(rut1, rut2, sepa1, sepa2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiPuntoTres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiPuntoTres().setVisible(true);
            }
        });
    }
